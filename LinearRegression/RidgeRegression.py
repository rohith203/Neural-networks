"""
This file contains the classes that implement Linear Regression with regularization.
"""
import numpy as np
...
class RidgeRegression:
    """
    This class implements Linear Regression with regularization using both
